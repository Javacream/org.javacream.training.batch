...
public class JobRestController {
	...
	public String executeJob(@RequestBody JobLaunchRequest jobLaunchRequest) {
		...
		JobParametersBuilder jobParametersBuilder = new JobParametersBuilder(new DefaultJobParametersConverter().getJobParameters(jobLaunchRequest.getJobParameters()));
